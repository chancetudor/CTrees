...
BSTOBJS = tnode.o bst.o queue.o cda.o bst-0-12.o string.o real.o integer.o
GSTOBJS = tnode.o bst.o queue.o cda.o gst.o gst-0-10.o integer.o real.o
...
bst-0-12.o : bst-0-12.c string.h queue.h bst.h integer.h real.h
	gcc $(OOPTS) bst-0-12.c
gst-0-10.o : gst-0-10.c integer.h string.h queue.h bst.h real.h
	gcc $(OOPTS) gst-0-10.c
